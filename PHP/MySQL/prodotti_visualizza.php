...
<body>
    ...
    <div class="container">
        ...
        <h1>Elenco prodotti del sito</h1>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                $ris = $conn->query("SELECT prodotti.id, prodotti.nome as nome, prodotti.prezzo, prodotti.qta, categorie.nome as categoria
                                    FROM prodotti
                                    INNER JOIN categorie ON categorie.id = prodotti.id_categoria");
